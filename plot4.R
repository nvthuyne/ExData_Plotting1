...
setwd('C://Users//nicky/Downloads')
# Read data, convert dates and subset on two days in February 2007
data <- read.table('C://Users//nicky/Downloads//household_power_consumption.txt', sep=';', header=T,colClasses = c('character', 'character', 'numeric','numeric', 'numeric', 'numeric','numeric', 'numeric', 'numeric'),na.strings='?')
